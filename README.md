...
Logan's password is `tequieromucho` while lewis' remains uncracked, but we know it already because of the joomla exploit used earlier. With logan's password in hand, we are able to log into Logan's account:
