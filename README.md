...
Before fuzzing the log in, I first google to see if there are any exploits for joomla, and I do find one on exploit-db [here](https://www.exploit-db.com/exploits/51334). **CVE-2023-23752**
