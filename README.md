...
Before I lightly fuz the log in, I first google to see if there are any exploits for joomla, and I find **CVE-2023-23752** on exploit-db [here](https://www.exploit-db.com/exploits/51334). 
